...
--             c(1, {t("public "), t("private ")}), t("class "), i(2), t(" "),
--             c(3, {
--                 t("{"),
...
--         ls.parser.parse_snippet("lspsyn",
--                                 "Wow! This ${1:Stuff} really ${2:works. ${3:Well, a bit.}}"),
--
--         -- When wordTrig is set to false, snippets may also expand inside other words.
--         ls.parser.parse_snippet({trig = "te", wordTrig = false},
...
--         s({trig = "a%d", regTrig = true}, f(
--               function(_, snip)
--                 return "Triggered with " .. snip.trigger .. "."
--             end, {})),
--         -- It's possible to use capture-groups inside regex-triggers.
--         s({trig = "b(%d)", regTrig = true}, f(
--               function(_, snip)
...
--             c(1, {t("public "), t("private ")}), c(2, {
--                 t("void"), t("String"), t("char"), t("int"), t("double"),
--                 t("boolean"), i(nil, "")
--             }), t(" "), i(3, "myFunc"), t("("), i(4), t(")"),
...
require("luasnip.loaders.from_vscode").load({include = {"tex"}}) -- Load only python snippets
require("luasnip.loaders.from_vscode").load({include = {"md"}}) -- Load only python snippets
